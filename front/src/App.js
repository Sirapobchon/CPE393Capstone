...
import TicTacToeAI from "./Components/TicTacToe/TicTacToeAI";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/TicTacToeAI"
          element={<ProtectedRoute component={TicTacToeAI} />}
        />
        ...
        <Route
          path="/MainGame"
          element={<ProtectedRoute component={MainGame} />}
        />
        <Route
          path="/GameMode"
          element={<ProtectedRoute component={GameMode} />}
        />
